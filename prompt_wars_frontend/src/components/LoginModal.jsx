...
export default function LoginModal({ isOpen, onClose, onLogin }) {
  ...
  const handleGoogleAuth = (selectedEmail = 'prashanthraodugyala34@gmail.com', customName = 'Prashanth Rao') => {
    sound.playClick();
    ...
    setTimeout(() => {
      ...
      const userProfile = {
        ...
        bio: 'Authenticated via Google OAuth on Equipo.',
        hackathons_won: 2,
        timezone: 'IST (UTC+5:30)'
      };
    ...
    <div style={{
      ...
      <div className="enterprise-card" style={{
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          <button
            type="button"
            onClick={() => handleGoogleAuth('prashanthraodugyala34@gmail.com', 'Prashanth Rao')}
